...
var bandera = false; //esto indica si el juego inicio
var turno= 0; //esto determina el turno
var tab = new Array(); //reune todos lo botones del jueguillo

window.onload = function() { /*evento para que inicie el juego*/
